...
An [esbuild](https://esbuild.github.io/) [plugin](https://esbuild.github.io/plugins/) that adds support for `.frag`, `.vert` and `.glsl` file imports with optional shader code minification.
